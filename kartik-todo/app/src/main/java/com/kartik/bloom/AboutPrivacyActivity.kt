...
private fun AboutPrivacyScreen() {
    LazyColumn(
        ...
        item {
            ...
            Text("Version 1.4.0 • A focused productivity planner by Kynure Labs", color = Color(0xFF817985))
        }
        ...
        item { InfoCard("Data collection") { Text("Bloom 1.4.0 has no account system, advertising SDK, analytics SDK or third-party tracking SDK. Your task list is not sent to a Kynure Labs server.") } }
